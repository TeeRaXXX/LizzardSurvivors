...
public static class EventManager
{
    ...
    public static readonly UnityEvent<SkillType, int> OnSkillAdded = new UnityEvent<SkillType, int>();
    public static readonly UnityEvent<SkillType, int> OnSkillDeleted = new UnityEvent<SkillType, int>();
    ...
    public static readonly UnityEvent OnChestPickUp = new UnityEvent();
    ...
    public static void OnSkillAddedEvent(SkillType skillType, int level) => OnSkillAdded.Invoke(skillType, level);
    public static void OnSkillDeletedEvent(SkillType skillType, int level) => OnSkillDeleted.Invoke(skillType, level);
    ...
    public static void OnChestPickUpEvent() => OnChestPickUp.Invoke();
