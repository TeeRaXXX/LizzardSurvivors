...
public static class EventManager
{
    ...
    public static readonly UnityEvent<float> OnExperienceUp = new UnityEvent<float>();
    ...
    public static void OnExperienceUpEvent(float newExperience) => OnExperienceUp.Invoke(newExperience);
